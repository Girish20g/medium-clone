...
function Post({ post }: Props) {
  ...
  return (
    <main>
        ...
        >
          ...
          <label className="block mb-5">
            ...
            <input
              ...
              className="shadow border rounded py-2 px-3 form-input mt-1 block w-full  focus:ring ring-yellow-500 focus:outline-none"
              placeholder="Name"
              type="text"
              name="name"
            />
          ...
          <label className="block mb-5">
            ...
            <textarea
              ...
              className="shadow border rounded py-2 px-3 form-textarea mt-1 block w-full  focus:ring ring-yellow-500 focus:outline-none"
              placeholder="Comment"
              rows={8}
              name="comment"
            />
      ...
      <div className="flex flex-col p-10 my-10 max-w-xl mx-auto shadow shadow-yellow-500 space-y-2">
